...
Acl.prototype.check = function(roles, resources, permissions){
    ...
    // check(roles, grants)
    return _.all(roles, function(role){ // TODO: benchmark & optimize
        return this[role] !== undefined &&
            _.all(Object.keys(grants), function(resource){
...
Acl.prototype.checkAny = function(roles, resources, permissions){
    ...
    if (_.isEmpty(grants))
        return true;
    return _.any(roles, function(role){ // TODO: benchmark & optimize
        return this[role] !== undefined &&
            _.any(Object.keys(grants), function(resource){
